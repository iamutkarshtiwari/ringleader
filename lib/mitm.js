...
var MitmProxy = function () {
  ...
  // Attach the modify handler
  Services.obs.addObserver(modify, 'http-on-modify-request', false);
}
...
const modify= {
  observe: function (subject, topic, data) {
    if (topic == "http-on-modify-request") {
      ...
      let topWin = loadContext.topWindow;
      //TODO: Fix the tab key function in secutils 
      let key = Utils.getKeyFromChannel(topWin);
